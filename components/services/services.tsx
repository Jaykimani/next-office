        ...
        <div className={styles.servicesInset}>
            <div className={styles.feature}>
                <div className={styles.featureImage}>
                  <Image className={styles.featureImg} src="/stationery5.jpg" alt="fast shipping" width={500} height={500}/>
                </div>
            ...
            <div className={styles.feature}>
              <div className={styles.featureImage}>
                  <Image className={styles.featureImg} src="/printer.jpg" alt="fast shipping" width={500} height={500}/>
                </div>
              <div className={styles.featureInfo}>
            ...
            <div className={styles.feature}>
                 <div className={styles.featureImage}>
                  <Image className={styles.featureImg} src="/tech1.jpg" alt="fast shipping" width={500} height={500}/>
                </div>
                <div className={styles.featureInfo}>
